...
class NeptixWidget extends WP_Widget {
    function NeptixWidget() {
        $options = array( 'description' => __( "Neptix Widget Events") );
        parent::WP_Widget(false, $name = 'Neptix Events', $options);   
    }
    function widget($args, $instance)
    {
        ...
        echo $before_widget;
            ...
            echo neptix_get_events($instance['type'], $instance['id'], $is_widget = true, $total_events, $show_thumb, "", $show_only_events, $exclude_events, $private_events, $alignment);
        echo $after_widget;
    ...
    function update($new_instance, $old_instance) {
        if (!isset($new_instance["show_thumb"]))
            $new_instance["show_thumb"] = "off";
        return $new_instance;
    }
...
add_action('widgets_init', create_function('', 'return register_widget("NeptixWidget");'));
